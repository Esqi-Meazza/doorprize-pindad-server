...
router.get(
  '/peserta-paged',
  verifyAdminToken,
  validate(pagedPesertaSchema, 'query'),
  adminController.getPesertaPaged,
);
...
router.get(
  '/pemenang-paged',
  verifyAdminToken,
  validate(pagedPemenangSchema, 'query'),
  adminController.getPemenangPaged,
);
router.delete(
  '/pemenang/:id_pemenang/diskualifikasi',
  verifyAdminToken,
  adminController.diskualifikasiPemenang,
);
//hadiah
...
router.get(
  '/hadiah-paged',
  verifyAdminToken,
  validate(pagedHadiahSchema, 'query'),
  adminController.getHadiahPaged,
); // Dipakai untuk Tabel
...
router.get(
  '/kelompok-paged',
  verifyAdminToken,
  validate(pagedKelompokSchema, 'query'),
  adminController.getKelompokPaged,
);
