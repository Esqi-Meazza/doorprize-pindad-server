...
const participantCredentialsSchema = z
  .object({
...
const userLogoutSchema = z
  .object({
    id_user: positiveInteger,
  })
  .strict();

const spinSessionSchema = z
  .object({
